...
<head>
  ...
  <title>DSR Moving Corporation : Employment</title>
...
<!-- Navigation -->
   ...
   <nav class="white" role="navigation">
      <a id="logo-container" href="index.html" class="brand-logo "><img src="assets/images/logo.gif"></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h5 class="header col s12 light">Careers</h5>
        </div>
...
<!-- footer -->
  <footer class="page-footer teal">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">DSR Moving Professionals</h5>
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="https://www.yelp.com/biz/dsr-moving-corporation-raleigh">Yelp</a></li>
            <li><a class="white-text" href="#!">Google</a></li>
            <li><a class="white-text" href="https://www.facebook.com/dsrmovingnc/">Facebook</a></li>
          </ul>
        </div>
        <div class="col l3 s12">
          <h5 class="white-text">Find us</h5>
          <ul >
            <li >251 Dominion Dr, Morrisville, NC 27560</li>
           
            <li >1722 E. 11th Street, Siler City, NC 27344</li>
          </ul>
        </div>
      </div>
    </div>
    <div class="footer-copyright">
      <div class="container">
        © 2005 by DSR Moving Corporation
      </div>
    </div>
  </footer>
